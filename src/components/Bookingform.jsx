...
// // //   const [selectedFlight, setSelectedFlight] = useState(null); // New state for selected flight
...
// // //         updateSearchResults(result.availableFlights);
...
//           startDate={startDate} // Pass the startDate prop
//   endDate={endDate} 
//          />
//       )}
...
function BookingForm() {
  ...
  return (
    <div>
      ...
      {searched && availableFlights.length > 0 && (
        <AvailableFlights availableFlights={availableFlights} startDate={startDate} endDate={endDate} />
      )}
