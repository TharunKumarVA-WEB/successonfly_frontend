...
function BookingPage() {
  ...
  // Default departure and arrival dates (today's date)
  ...
  // State for departure and arrival dates
  ...
  const handleConfirmBooking = () => {
    // Add your logic here to handle the booking confirmation
    // This is just an example, you can replace it with your actual logic
    alert(`Booking confirmed for ${numAdults} adults, ${numChildren} children in ${selectedClass} class on ${departureDate}.`);
    // Redirect the user to the previous page after confirming the booking
    navigate('/'); // Navigate back one step
  };
